            ...
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <select name="color" v-model="form.color" id="color" class="form-control" :class="{ 'is-invalid': form.errors.has('color') }">
                    ...
                    <div class="form-group">
                        <select name="frame_material" v-model="form.frame_material" id="frame_material" class="form-control" :class="{ 'is-invalid': form.errors.has('frame_material') }">
                     ...
                     <div class="form-group">
                        <vue-editor placeholder="Short description for product"
                        v-model="form.description" :class="{ 'is-invalid': form.errors.has('description') }"></vue-editor>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <select name="speed" v-model="form.speed" id="speed" class="form-control" :class="{ 'is-invalid': form.errors.has('speed') }">
                    ...
                    <div class="form-group">
                        <select name="wheel_size" v-model="form.wheel_size" id="wheel_size" class="form-control" :class="{ 'is-invalid': form.errors.has('wheel_size') }">
                    ...
                    <div class="form-group">
                        <select name="wheel_spec" v-model="form.wheel_spec" id="wheel_spec" class="form-control" :class="{ 'is-invalid': form.errors.has('wheel_spec') }">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <input type="price" name="price"
                            placeholder="Price"
                            class="form-control" v-model="form.price" :class="{ 'is-invalid': form.errors.has('price') }">
                     ...
                     <div class="form-group">
                        <input type="amount" name="amount"
                            placeholder="Amount"
                            class="form-control" v-model="form.amount" :class="{ 'is-invalid': form.errors.has('amount') }">
